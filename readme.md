...
I've patched together the examples at
...
to create a stand-along project that demonstrates how to create a simple virtual
joystick.

## Usage

Open `VirtualJoystickForm.pro` in Qt Creator and configure the project for your
